...
<head>
  ...
  <style>
    ...
    .grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 15px; padding: 10px; max-width: 1200px; margin: 10px auto 30px auto; }
...
<body>
  ...
  <h2 class="section-title">Audífonos Disponibles</h2>
  <section class="grid">
    <div class="card">
      <img src="imagenes/inalambrico1.jpg" alt="Audífono Modelo A">
      <h3>Modelo A Bluetooth</h3>
      <p>$599 MXN</p>
    </div>
    <div class="card">
      <img src="imagenes/inalambrico2.jpg" alt="Audífono Modelo B">
      <h3>Modelo B Bluetooth</h3>
      <p>$499 MXN</p>
    </div>
    <div class="card">
      <img src="imagenes/alambrico1.jpg" alt="Audífono Modelo C">
      <h3>Modelo C con cable</h3>
      <p>$399 MXN</p>
    </div>
    <div class="card">
      <img src="imagenes/alambrico2.jpg" alt="Audífono Modelo D">
      <h3>Modelo D con cable</h3>
      <p>$419 MXN</p>
    </div>
  </section>
