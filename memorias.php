...
<head>
  ...
  <title>Memorias de Celular</title>
...
<section class="grid" id="memoriaGrid">
  <div class="card" data-marca="Samsung" data-modelo="S22">
    <img src="memoriaSamsungS22.jpg" alt="Memoria Samsung S22">
    <h3>Memoria 128GB</h3>
  ...
  <div class="card" data-marca="Apple" data-modelo="iPhone14">
    <img src="memoriaIphone14.jpg" alt="Memoria iPhone 14">
    <h3>Memoria 256GB</h3>
    <div class="marca-modelo">Marca: Apple | Modelo: iPhone 14</div>
    <p>$899 MXN</p>
  </div>

  <!-- Agrega más memorias aquí -->
</section>
...
const cards = document.querySelectorAll('#memoriaGrid .card');
