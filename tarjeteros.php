...
<head>
  ...
  <title>Tarjeteros de Celular</title>
...
<section class="grid" id="tarjeteroGrid">
  <div class="card" data-marca="Samsung" data-modelo="S22">
    <img src="tarjeteroSamsungS22.jpg" alt="Tarjetero Samsung S22">
    <h3>Tarjetero Slim</h3>
    <div class="marca-modelo">Marca: Samsung | Modelo: S22</div>
    <p>$199 MXN</p>
  </div>

  <div class="card" data-marca="Apple" data-modelo="iPhone14">
    <img src="tarjeteroIphone14.jpg" alt="Tarjetero iPhone 14">
    <h3>Tarjetero de Piel</h3>
    <div class="marca-modelo">Marca: Apple | Modelo: iPhone 14</div>
    <p>$249 MXN</p>
  </div>

  <!-- Agrega más tarjeteros aquí -->
</section>
...
const cards = document.querySelectorAll('#tarjeteroGrid .card');
